...
import com.example.onlineshoppingapp.databinding.ViewholderPicmainBinding;
...
public class PicListAdapter extends RecyclerView.Adapter<PicListAdapter.Viewholder> {
    ...
    public PicListAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewholderPicmainBinding binding=
                ViewholderPicmainBinding.inflate(LayoutInflater.from(context),parent,false);
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        ViewholderPicmainBinding binding;
        public Viewholder(ViewholderPicmainBinding binding) {
